...
<body>
    ...
    <div class="containers">
        ...
        <div class="container">
            <form action="{{ url('updateFile/'.$editData->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('POST')
                ...
                <input type="text" name="name" id="" value="{{$editData->name}}" class="form-control">
                <br>
                {{-- <label for="">Tag</label>
                ...
                <label for="" class="form-label">File Description</label><input type="text" name="desc"
                    class="form-control" value="{{$editData->file_desc}}" placeholder="Enter Description">
                <br>
                {{-- <br> --}}
                ...
                <input type="text" id="type" name="type" class="form-control"
                    placeholder="No need to write here anyting (It will update Automatically)" value="{{$editData->file_type}}" readonly>
                <br>
