                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    @endif
                                    <form class="mx-1 mx-md-4" action="{{ url('updateUser/' . $registration->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('POST')
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                ...
                                                <input type="text" id="form3Example1c" name="name"
                                                    class="form-control" value="{{ $registration->name }}"
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                ...
                                                <input type="email" id="form3Example3c" name="email"
                                                    class="form-control" value="{{ $registration->email }}"
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="role"
                                                        ...
                                                        @if ($registration->role == 1) checked @endif>
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="role"
                                                        ...
                                                        @if ($registration->role == 0) checked @endif>
