...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('showUser') }}">Users List</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-5">
        ...
        <a href="{{ route('addUser') }}"><button type="button" class="btn btn-warning" style="float: right;">Add
                User.</button></a>
        <br><br>
            ...
            <tbody>
                @foreach ($data as $d)
                    <tr>
                        ...
                        <td>{{ $d->email }}</td>
                        <td>{{ $d->created_at }}</td>
                        <td><a href="{{ url('editUser/' . $d->id) }}">Edit</a></td>
