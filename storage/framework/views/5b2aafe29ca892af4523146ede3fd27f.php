                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form class="mx-1 mx-md-4" action="<?php echo e(route('signingUp')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="form-check d-flex justify-content-center mb-5">
                                            ...
                                            <label class="form-check-label" for="form2Example3">
                                                I agree all statements in <a href="<?php echo e(route('terms')); ?>">Terms of
                                                    service</a>
                                            </label>
                                        </div>
...
<?php /**PATH /home/dweekstudios/test-project/resources/views/signup.blade.php ENDPATH**/ ?>