        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('showUser')); ?>">Users List</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <?php endif; ?>
                                    <form class="mx-1 mx-md-4" action="<?php echo e(url('updateUser/' . $registration->id)); ?>"
                                        method="POST">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                ...
                                                <input type="text" id="form3Example1c" name="name"
                                                    class="form-control" value="<?php echo e($registration->name); ?>"
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                ...
                                                <input type="email" id="form3Example3c" name="email"
                                                    class="form-control" value="<?php echo e($registration->email); ?>"
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="role"
                                                        ...
                                                        <?php if($registration->role == 1): ?> checked <?php endif; ?>>
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="role"
                                                        ...
                                                        <?php if($registration->role == 0): ?> checked <?php endif; ?>>
...
<?php /**PATH /home/dweekstudios/test-project/resources/views/editUser.blade.php ENDPATH**/ ?>