...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo e(route('showData')); ?>">User Uploaded Files</a>
                    </li>
                </ul>
    ...
    <div class="container mt-5">
        <a href="<?php echo e(route('adminUpload')); ?>"><button type="button" class="btn btn-warning" style="float: right;">Add
                File.</button></a>
            ...
            <tbody>
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><a href="<?php echo e(url('deleteFiles/' . $d->id)); ?>">Delete</a></td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
